...
if stringrel(stringnorm (o.album_artist), 'variousartist') > 0.7 then
	tags.album_artist = o.album .. ' (Various)'
end
...
-- customized: preserve some tags comment
tags.comment = empty(o.comment) and nil or o.comment
tags.publisher = empty(o.publisher) and nil or o.publisher
tags.tracktotal = empty(o.tracktotal) and nil or o.tracktotal
-- retain replaygain
tags.replaygain_album_gain = empty(o.replaygain_album_gain) and nil or o.replaygain_album_gain
tags.replaygain_album_peak = empty(o.replaygain_album_peak) and nil or o.replaygain_album_peak
tags.replaygain_reference_loudness = empty(o.replaygain_reference_loudness) and nil or o.replaygain_reference_loudness
tags.replaygain_track_gain = empty(o.replaygain_track_gain) and nil or o.replaygain_track_gain
tags.replaygain_track_peak = empty(o.replaygain_track_peak) and nil or o.replaygain_track_peak
